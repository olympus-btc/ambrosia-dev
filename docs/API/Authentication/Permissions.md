...
:::info
- La asignación de permisos a roles se gestiona desde los endpoints de Roles (`PUT /roles/{id}/permissions`).
- La propiedad `name` es la clave que se usa para asignar permisos (por ejemplo: `products_read`, `orders_update`).
:::
